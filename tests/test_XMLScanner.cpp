...
typedef textwolf::Buffer BufferType;
...
int main( int, const char**)
{
	...
	typedef XMLScanner<char*,charset::IsoLatin1,charset::IsoLatin1,BufferType> MyXMLScanner;
	MyXMLScanner::OutputBuffer outputbuf(1000);
